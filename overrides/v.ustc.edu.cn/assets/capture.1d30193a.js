import { at as a, h as c, au as o, av as g, ez as l, aG as C } from "./index.1b2319a9.js";
import { P as h } from "./schedule.1e16344c.js";
var v = Object.defineProperty
    , z = Object.getOwnPropertyDescriptor
    , s = (e, t, r, p) => {
        for (var n = p > 1 ? void 0 : p ? z(t, r) : t, u = e.length - 1, m; u >= 0; u--)
...
const f = async (e, t, r = !1) => {
    ...
    return (await c.get(`/api/v1/captures/${e}/capture-iframe-url?language=${t}`, {
        params: p
    })).data
}
    , K = async e => {
    ...
    , P = async (e, t) => (await c.put("/api/v1/capture-settings", {
        keys: e,
        values: t
    })).data
    , B = async e => {
        ...
        return (await c.post("/api/v1/capture-tags:batchGet", o.exports.decamelizeKeys(t))).data.data
    }
    , G = async (e, t) => {
    ...
    , j = async (e, t) => {
        ...
        p = { data: { error: {} } };
        return p.data.error = o.exports.camelizeKeys(p.data.error),
            p.data
    }
    ;
export { f as a, b, D as c, B as d, L as e, _ as f, O as g, K as h, j as i, S as j, $ as k, I as l, G as p, P as u };
