import { at as c, aB as x, aC as z, aD as C, aE as h, aF as w, h as i, aG as y, au as n, av as m, aH as K, aI as f } from "./index.1b2319a9.js";
import { C as b, S } from "./schedule.1e16344c.js";
import { S as I } from "./semester.ca88aa01.js";
var D = Object.defineProperty
    , N = Object.getOwnPropertyDescriptor
    , p = (e, t, r, a) => {
        for (var o = a > 1 ? void 0 : a ? N(t, r) : t, u = e.length - 1, d; u >= 0; u--)
            (d = e[u]) && (o = (a ? d(t, r, o) : d(o)) || o);
        return a && o && D(t, r, o),
            o
    }
    , P = (e => (e.UPCOMING = "UPCOMING",
...
const E = async (e = {}, t = 1, r = 10) => {
    ...
    const o = await i.get("/api/v1/capture-courses", {
        ...
        , d = u.items;
    return u.items = m(s, d),
        u
}
    , R = async e => {
        const t = await i.get(`/api/v1/course/${e}/schedules`);
        return K(t.data.data) ? [] : m(S, t.data.data, {
            strategy: "excludeAll"
        })
    }
    , $ = async e => {
        if (e.length) {
            ...
            return (await i.get("/api/v1/course/avatar", {
                params: t
            })).data || {}
        }
        return {}
    ...
    , T = async (e = {}, t = 1, r = 10) => {
        const a = {
            ...
            , u = (await i.get("/api/v1/user-courses", {
                params: n.exports.decamelizeKeys(a)
            })).data.data
            , d = m(s, u.items);
        delete u.items;
    ...
    , _ = async e => {
        ...
        return (await i.get("/api/v1/capture-courses/classroom-names", {
            params: t
        })).data.data
    }
    , A = async (e, t) => (await i.put(`/api/v1/capture-courses/${e}/setting`, n.exports.decamelizeKeys(t))).data
    , V = async (e, t) => {
        const r = n.exports.decamelizeKeys({
            ...y(e, o => o !== "")
        });
        return (await i.put("/api/v1/capture-courses:batchSetting", n.exports.decamelizeKeys(t), {
            params: r
        })).data
    }
    , j = async e => {
        ...
        return (await i.get("/api/v1/capture-courses:batchGetCount", {
            params: t
        })).data
    }
    , M = async e => {
    ...
    , H = async (e, t) => {
        const r = await i.get(`/api/v1/capture-courses/${e}/recently-visited-users`, {
    ...
    , L = async (e, t, r) => {
        ...
        const a = {
            ...
            , o = await i.get(`/api/v1/capture-courses?keyword=${t}&status=INPROGRESS&semester_id=${semesterId}&page=1&page_size=1`, {
                params: a
            });
        return o.data.data.items[0] = m(s, n.exports.camelizeKeys(o.data.data.items[0]), {
            strategy: "excludeAll"
        }),
    ...
    , Y = async (e, t) => {
        ...
        return a.data.data = m(s, n.exports.camelizeKeys(a.data.data), {
            strategy: "excludeAll"
        }),
    ...
    ;
export { P as C, $ as a, F as b, H as c, j as d, V as e, _ as f, E as g, U as h, Y as i, L as j, R as k, T as l, M as t, A as u };
